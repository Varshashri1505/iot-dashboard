...
// Customize chart colors to match college theme
const CHART_COLORS = [
  'var(--primary-color)',
  'var(--secondary-color)',
  'var(--accent-color)',
...
const PredictionDistributionChart = () => {
  ...
  const data = [
    { name: "Toilet", value: 40 },
    { name: "Shower", value: 25 },
    { name: "Faucet", value: 20 },
    { name: "Dishwasher", value: 15 }
  ];
...
//Add a real-time prediction indicator
  ...
  return (
    <div className="card">
      <div className="card-header">
        <h3>Real-Time Activity Prediction</h3>
      </div>

      <div className="card-value">
        <span className="value">{prediction.activity}</span>
      </div>
...
const ActivityTimeline = () => {
  ...
  const data = [
    ...
    { time: "10:30", duration: 3 },
    { time: "11:00", duration: 7 },
    { time: "11:30", duration: 4 }
  ];
